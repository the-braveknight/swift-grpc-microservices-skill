...
Publish the gateway's HTTP port and nothing else. Upstream gRPC services keep no `ports:`; they
are reachable by service name on the internal network and by nothing outside it.
